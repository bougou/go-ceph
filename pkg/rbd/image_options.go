...
type RbdImageOptionFn func(*cephrbd.ImageOptions) error

func rbdImageOptionsFromFns(fns ...RbdImageOptionFn) (opts *cephrbd.ImageOptions, err error) {
...
func RbdOptUint64(option cephrbd.ImageOption, value uint64) RbdImageOptionFn {
...
func RbdOptString(option cephrbd.ImageOption, value string) RbdImageOptionFn {
	return func(o *cephrbd.ImageOptions) error {
